...
//String to translate
#define CONTACTS_STRING [OTRLanguageManager translatedString: @"Contacts"]
#define LIST_OF_DIFUSSION_STRING [OTRLanguageManager translatedString: @"Broadcast List"]
#define NEW_BROADCAST_LIST_STRING [OTRLanguageManager translatedString: @"New Broadcast List"]
#define XMPP_FAIL_STRING [OTRLanguageManager translatedString: @"Incorrect Username or/and Password."]
#define DOMAIN_PASS_BLANK_STRING [OTRLanguageManager translatedString: @"You must enter a domain to login."]
#define EVENTS_STRING [OTRLanguageManager translatedString: @"Events"]
#define ADD_EVENT_STRING [OTRLanguageManager translatedString: @"Add Event"]
#define SELECT_CONTACTS_STRING [OTRLanguageManager translatedString: @"Select Contacts"]
#define TYPE_CONTACT_NAME_STRING [OTRLanguageManager translatedString: @"Type contact name"]
#define TITLE_STRING [OTRLanguageManager translatedString: @"Title"]
#define LOCATION_STRING [OTRLanguageManager translatedString: @"Location"]
#define START_DATE_STRING [OTRLanguageManager translatedString: @"Starts"]
#define ENDS_DATE_STRING [OTRLanguageManager translatedString: @"Ends"]
#define INVITEES_STRING [OTRLanguageManager translatedString: @"Invitees"]
#define ADD_MEMBERS_STRING [OTRLanguageManager translatedString: @"Add Members"]
#define NOTES_STRING [OTRLanguageManager translatedString: @"Notes"]
#define ALLDAY_STRING [OTRLanguageManager translatedString: @"All-day"]
#define REPEAT_STRING [OTRLanguageManager translatedString: @"Repeat"]
#define TRAVEL_TIME_STRING [OTRLanguageManager translatedString: @"Travel Time"]
#define NEVER_STRING [OTRLanguageManager translatedString: @"Never"]
#define EVERY_DAY_STRING [OTRLanguageManager translatedString: @"Every Day"]
#define EVERY_WEEK_STRING [OTRLanguageManager translatedString: @"Every Week"]
#define EVERY_TWO_WEEKS_STRING [OTRLanguageManager translatedString: @"Every two Weeks"]
#define EVERY_MONTH_STRING [OTRLanguageManager translatedString: @"Every Month"]
#define EVERY_YEAR_STRING [OTRLanguageManager translatedString: @"Every Year"]
#define ALERT_STRING [OTRLanguageManager translatedString: @"Alert"]
#define EVENT_ALERT_STRING [OTRLanguageManager translatedString: @"Event Alert"]
#define NONE_STRING [OTRLanguageManager translatedString: @"None"]
#define AT_TIME_OF_EVENT_STRING [OTRLanguageManager translatedString: @"At time of event"]
#define FIVE_MINUTES_BEFORE_STRING [OTRLanguageManager translatedString: @"5 minutes before"]
#define FIFTEEN_MINUTES_BEFORE_STRING [OTRLanguageManager translatedString: @"15 minutes before"]
#define THIRTY_MINUTES_BEFORE_STRING [OTRLanguageManager translatedString: @"30 minutes before"]
#define ONE_HOUR_BEFORE_STRING [OTRLanguageManager translatedString: @"1 hour before"]
#define TWO_HOURS_BEFORE_STRING [OTRLanguageManager translatedString: @"2 hours before"]
#define ONE_DAY_BEFORE_STRING [OTRLanguageManager translatedString: @"1 day before"]
#define TWO_DAYS_BEFORE_STRING [OTRLanguageManager translatedString: @"2 days before"]
#define SHOW_AS_STRING [OTRLanguageManager translatedString: @"Show As"]
#define FREE_STRING [OTRLanguageManager translatedString: @"Free"]
#define BUSY_STRING [OTRLanguageManager translatedString: @"Busy"]
#define URL_STRING [OTRLanguageManager translatedString: @"Url"]
#define SECOND_ALERT_STRING [OTRLanguageManager translatedString: @"Second Alert"]
#define CALENDAR_STRING [OTRLanguageManager translatedString: @"Calendar"]
#define DELETE_EVENT_STRING [OTRLanguageManager translatedString:@"Delete Event"]
#define REPEATS_STRING [OTRLanguageManager translatedString:@"Repeats"]
#define YEARLY_STRING [OTRLanguageManager translatedString:@"yearly"]
#define DAILY_STRING [OTRLanguageManager translatedString:@"daily"]
#define WEEKLY_STRING [OTRLanguageManager translatedString:@"weekly"]
#define MONTHLY_STRING [OTRLanguageManager translatedString:@"monthly"]
#define SERVICE_SETTING_TITLE [OTRLanguageManager translatedString: @"Enable File-sharing Service "]
#define SERVICE_SETTING_DESCRIPTION [OTRLanguageManager translatedString: @"Enabled using Sercvice for file sharing"]
#define MEDIA_ITEM_STRING [OTRLanguageManager translatedString: @"File Item"]
#define SCREENSHOT_STRING [OTRLanguageManager translatedString: @"Screenshot"]
#define CONTACT_INFO_STRING [OTRLanguageManager translatedString: @"Contact Info"]
#define LAST_SEEN_STRING [OTRLanguageManager translatedString: @"Last seen "]
#define LAST_PRESENCE_STRING [OTRLanguageManager translatedString: @"Last presence "]
#define CLEAR_CHAT_STRING [OTRLanguageManager translatedString: @"Clear Chat"]
