...
typedef void (^RQCompletionHandler)(NSString* transferId, NSURLResponse *response, NSData *data, NSError *error);
typedef void (^RQProgressHandler)(NSString *transferId, float progress, NSInteger bytesTransferred, NSInteger totalBytes);
